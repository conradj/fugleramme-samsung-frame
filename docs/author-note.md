...
I am reasonably technical but haven't done a security audit on this.

Also note that currently Fugleramme doesn't support the Frame TVs native resolution of 3840x2160. In the admin page I've chosen 4k resolution and a margin of 13%. This will mean you can't choose a Matt for the image. If Fugleramme does start to support native resolutions I think it is possible to change this script to preserve the Matt on each update, but for now that doesn't happen.
